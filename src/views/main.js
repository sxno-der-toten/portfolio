const presentation = () => `
<section
  class="relative bg-[url(https://r4.wallpaperflare.com/wallpaper/375/1004/16/5k-cgi-dark-mountains-wallpaper-47df42946f153faaff62643181112735.jpg)] bg-cover bg-center bg-no-repeat"
>
  <div
  ...
  >
    <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
      <h1 class="text-3xl font-extrabold text-[#7496af] sm:text-5xl">
        DÉVELOPPEUR

        <strong class="block font-extrabold text-[#131b2a]"> FULL STACK. </strong>
      </h1>

      <p class="mt-4 max-w-lg text-[#f5d8c9] sm:text-xl/relaxed">
        À la recherche de nouveaux défis pour enrichir mes compétences et contribuer à des projets innovants qui font la différence dans la vie des utilisateurs.
      </p>

      <!-- Centrer la flèche par rapport au bloc texte -->
      <div class="mt-8 flex justify-center">
        <a href="#"
   class="block text-center animate-bounce text-black hover:text-rose-700">
  <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <img src=https://i.ibb.co/7GcBQFR/memoji.png>
  </div>

<div class="mb-96 grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
  <!-- Première colonne - Mes projets -->
  <div class="flex flex-1 flex-col justify-between">
    <div class="border-s border-gray-900/10 p-4 sm:border-l-transparent sm:p-6">
      <a href="#">
        <h3 class="font-extrabold uppercase text-white">
          Mes projets >
        </h3>
      </a>

      <p class="mt-2 font-extrabold line-clamp-3 text-sm/relaxed text-[#212936]">
        Chatbot <br>
        Cool-lock <br>
        Memento <br>
        Fast food burger <br>
    ...
    <div class="sm:flex sm:items-end sm:justify-end">
      <a href="#" class="block bg-[#131b2a] px-5 py-1 text-center text-xs font-extrabold uppercase text-white transition hover:bg-black">
        Voir plus
      </a>
    </div>
  </div>

  <!-- Deuxième colonne - Mon profil -->
  <div class="flex flex-1 flex-col justify-between">
    <div class="border-s border-gray-900/10 p-4 sm:border-l-transparent sm:p-6">
      <a href="#">
        <h3 class="font-extrabold uppercase text-white">
  ...
  <div class="flex flex-1 flex-col justify-between">
    ...
    <div class="sm:flex sm:items-end sm:justify-end">
      ...
      <div class="mb-36 mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div class="lg:pr-4">
            <div class="lg:max-w-lg">
              <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Chatbot</h1>
              <p class="mt-6 text-xl leading-8 text-white">Interface sophistiquée permettant d'intéragir avec un chatbot grâce à une API en Javascript.</p>
            </div>
          </div>
        </div>
        <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img class="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" src="https://i.ibb.co/tDNsRgK/chatbot.jpg" alt="">
        </div>
        <div class="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div class="lg:pr-4">
            <div class="max-w-xl text-base leading-7 text-white lg:max-w-lg">
              <p>Projet réalisé en binôme, avec Youness Benakkaf</p>
              <ul role="list" class="mt-8 space-y-8 text-gray-600">
                <li class="flex gap-x-3">
                  <svg class="mt-1 h-5 w-5 flex-none text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              ...
              <p class="mt-8 mb-96">Projet réalisé dans le cadre de notre formation.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Texte à droite -->
    <div class="mt-9 mx-auto mb-96 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
  
  <!-- Image à gauche -->
  <div class="lg:sticky lg:top-4 lg:col-start-1 lg:row-start-1 lg:overflow-hidden">
  ...
  <div class="lg:col-span-1 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-1 lg:gap-x-8 lg:px-8">
    <div class="lg:pr-4">
      <div class="lg:max-w-lg">
        <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Cool Lock</h1>
        <p class="mt-6 text-xl leading-8 text-white">Site web permettant la mise en place de colocations.</p>
        <p>Projet réalisé en binôme, avec Youness Benakkaf</p>
        ...
        <p class="mt-8">Projet réalisé dans le cadre de notre formation.</p>
      </div>
    </div>
  </div>
</div>
